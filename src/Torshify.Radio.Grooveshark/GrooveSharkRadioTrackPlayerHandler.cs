...
{
    public class GrooveSharkRadioTrackPlayerHandler
    {
        #region Fields
        ...
        private readonly GroovesharkRadioTrack _track;
        private readonly Action<RadioTrack> _trackComplete;
        ...
        public GrooveSharkRadioTrackPlayerHandler(
            ILoggerFacade log,
            GroovesharkRadioTrack track,
            Action<RadioTrack> trackComplete,
        ...
        public void Initialize(HttpWebResponse response)
        {
