...
{
    public partial class SimilarArtistsRadioStationView : UserControl
    {
        #region Fields
        ...
        public SimilarArtistsRadioStationView(SimilarArtistsRadioStationViewModel viewModel)
        {
            InitializeComponent();
        ...
        public SimilarArtistsRadioStationViewModel Model
        {
            get { return DataContext as SimilarArtistsRadioStationViewModel; }
