...
namespace Torshify.Radio.Framework.Controls
{
    ...
    public class Planerator : FrameworkElement
    {
        ...
        private static readonly int[] _indices = new int[] { 0, 2, 1, 0, 3, 2 };

        // Static data
        private static readonly Point3D[] _mesh = new Point3D[] { new Point3D(0, 0, 0), new Point3D(0, 1, 0), new Point3D(1, 1, 0), new Point3D(1, 0, 0) };
        private static readonly Point[] _texCoords = new Point[] { new Point(0, 1), new Point(0, 0), new Point(1, 0), new Point(1, 1) };
        ...
        public class LayoutInvalidationCatcher : Decorator
        {
            ...
            {
                get { return this.Parent as Planerator; }
            }
